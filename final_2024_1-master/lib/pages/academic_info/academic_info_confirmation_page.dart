...
class AcademicInfoConfirmationPage extends StatelessWidget {
  final String title;
  final String infoLabel;
  final String info;
  final Function onConfirmed;

  const AcademicInfoConfirmationPage({super.key, required this.title, required this.infoLabel, required this.info, required this.onConfirmed});
